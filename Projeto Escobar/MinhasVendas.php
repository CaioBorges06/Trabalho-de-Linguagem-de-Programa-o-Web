...
if($resultado->num_rows > 0){
    ...
    while($venda = $resultado->fetch_assoc()){
        ...
        echo "<td> R$ ".$total."</td>";
        echo "<td style='backgorund-color: navy; align-items: center;'><a href='DetalhesComprador.php?id=". $venda['id'] ."' class='btn btn-primary' style='margin-left: 20px;'>detalhes do comprador</a></td>";
    ...
    echo "
        <div style='text-align: center; padding: 40px; background-color: navy;'>
        ...
        <div style='background-color: navy;'>
            <h1 style='font-family: Times New Roman; color: navy; font-size: 70px; padding: 262px'>Você ainda não fez vendas!</h1><br>
        </div> 
    ";
